...
public class BankServiceApplication {
    ...
    CommandLineRunner initDataBase(ICustomerService customerService,
        ...
        return args -> {
            // 1. Création du Client 1 (user1 / A100)
            ...
            // 2. Ajout des comptes pour user1
            ...
            // 3. Création du Client 2 (user2 / A200)
            customerService.createCustomer(AddCustomerRequest.builder()
                    .username("user2")
                    .identityRef("A200")
            ...
            // 5. Création du Client 3 (user3 / A900)
            customerService.createCustomer(AddCustomerRequest.builder()
                    .username("user3")
                    .identityRef("A900")
            ...
            // 6. Ajout compte pour user3 (solde négatif)
            bankAccountService.saveBankAccount(AddBankAccountRequest.builder()
                    .rib("RIB_9")
                    .amount(-25000d)
            ...
            // 7. Création du Client 4 (user4 / A800)
            customerService.createCustomer(AddCustomerRequest.builder()
                    .username("user4")
                    .identityRef("A800")
            ...
            // 8. Ajout compte pour user4 (solde zéro)
            bankAccountService.saveBankAccount(AddBankAccountRequest.builder()
                    .rib("RIB_8")
                    .amount(0.0)
            ...
            // --- Opérations de Virement (Transactions) ---

            // Virement de RIB_1 vers RIB_2 (10000.0) par user1
            ...
            // Virement de RIB_1 vers RIB_9 (20000.0) par user1
            transactionService.wiredTransfer(AddWirerTransferRequest.builder()
                    .ribFrom("RIB_1")
                    .ribTo("RIB_9")
                    .amount(20000.0)
            ...
            // Virement de RIB_1 vers RIB_8 (500.0) par user1
            transactionService.wiredTransfer(AddWirerTransferRequest.builder()
                    .ribFrom("RIB_1")
                    .ribTo("RIB_8")
                    .amount(500.0)
            ...
            // Virement de RIB_2 vers RIB_11 (300.0) par user2
            transactionService.wiredTransfer(AddWirerTransferRequest.builder()
                    .ribFrom("RIB_2")
                    .ribTo("RIB_11")
                    .amount(300.0)
